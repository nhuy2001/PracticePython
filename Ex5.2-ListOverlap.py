...
#Requirement: https://www.practicepython.org/exercise/2014/03/05/05-list-overlap.html
...
#Method 2: 
frameA = pd.DataFrame({'val': a})
frameB = pd.DataFrame({'val': b})

outputFrame = pd.merge(frameA, frameB, on = 'val', how = 'inner')
outputList = outputFrame['val'].values.tolist()
